          ...
          {this.state.showSideBar ?
            <div className="index-u">
              <ul className="index-ul">
                  ...
                  <Link to="/news"><li className="index-lis"><span><img className="index-lis-img" src={require('./news.png')}/><span>&nbsp;&nbsp;新闻资讯</span></span><span className="index-u-flex">ニュース情報</span></li></Link>
