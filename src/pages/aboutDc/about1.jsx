      ...
      <div>
        ...
        <div className="abouts">
          <div className="about">
              ...
              <div className="about-neirong">对于老师的甄选，大成日语是几近偏执的。我们始终认为，宁缺毋滥！责任心是我们对老师的要求，对学生负责，同样也要对自己负责。能力和经验也是一个优秀的教师不可或缺的，大成日语的老师许多都是有留日经验的归国留学生、有的曾是日企资深培训师。我们坚信，专业的事，需要专业的人。
              </div>
