      ...
      <div>
        ...
        <div className="abouts">
          <div className="about">
              ...
              <div className="about-neirong">对于老师的甄选，大成日语是几近偏执的。我们始终认为，宁缺毋滥！责任心是我们对老师的第一要求，对学生负责，同样也要对自己负责。能力和经验也是一个优秀的教师不可或缺的，大成日语的老师许多都是有留日经验的归国留学生、有的曾是日企资深培训师。我们坚信，专业的事，需要专业的人。
              </div>
              <div className="about-neirong">同时，我们注重教学团队的学习和交流，经常开展交流培训活动。努力营造平等、开放、快乐的学习和工作氛围。
              </div>
          </div>
          ...
          <div className="about-ls">
              ...
              <div className="about-ls-js">
                <div className="about-ls-ls">龟井老师</div>
