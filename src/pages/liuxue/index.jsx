       ...
       <Helmet title="日本留学" />
        ...
        <Liuxues>
            <Liuxue id="gaozhong">
                ...
                <H3>高中生留学</H3>
                <Title>留学条件</Title>
                <IndentBiaoti1>高中生赴日留学需要申请语言学校。在语言学校进行学习期间可以参加日本统一组织的日本留学生考试，最终进入理想的日本大学。申请语言学校需要满足的条件有：</IndentBiaoti1>
            ...
            <Liuxue id="daxue">
                ...
                <Biaoti1>3、	申请语言学校（专科生一般先申请语言学校过度）：需要目前为止的最高学历证明，学习过一定时间的日语（日语学时证明），具体依学校而定；</Biaoti1>
                <IndentBiaoti1>综上，留学条件里虽根据申请的等级不同而有所差异，但必不可少的一定是学习过日语，除此之外必须的就是有固定经济支付人，能保证你的学费正常交付。</IndentBiaoti1>
                <Title>材料准备</Title>
                <Biaoti1>1、	目前为止最高学历证明书；</Biaoti1>
            ...
            <Liuxue id="work">
                ...
                <h3>工作后留学</h3>
                <Title>留学条件</Title>
                <Biaoti1>1、	最终学历为本科专科的参照大学生留学；</Biaoti1>
                <Biaoti1>2、	最终学历为高中的参照高中生留学。</Biaoti1>
