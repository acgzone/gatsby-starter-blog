  ...
  return (
    <div className="liuxue">
        <div className="liuxue" id="gaozhong">
            ...
            <div className="liuxue-biaoti1">高中生赴日留学需要申请语言学校。在语言学校进行学习期间可以参加日本统一组织的日本留学生考试，最终进入理想的日本大学。申请语言学校需要满足的条件有：</div>
        ...
        <div className="liuxue" id="daxue">
            ...
            <div className="liuxue-biaoti1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;综上，留学条件里虽根据申请的等级不同而有所差异，但必不可少的一定是学习过日语，除此之外必须的就是有固定经济支付人，能保证你的学费正常交付。</div>
